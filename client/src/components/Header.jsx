...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center text-center mt-20 px-4 text-gray-800'>
      ...
      <p className='mb-8 max-w-md text-gray-400'>My name is <span className='font-bold'>Pankaj Kumar</span> and this is the assignment that was give by the Incruiter team to test my skills. This is the solution of the <span className='font-bold'>Backend Assignment.</span>
